...
namespace MachineLearningLibrary
{
    class RandomForest
    {
        ...
        public RandomForest(int maxT, int featureSize)
        {
            ...
            tree.CreateWithID3();
            Console.WriteLine("n,ITrainingError,ITestError,RTrainingAccuracy,RTestAccuracy");
            ...
            for (int n = 1; n < maxT; n++)
            {
                ...
                */
                ...
                tree.SetupBank();
                tree.BagTrainingData(count);
                tree.CreateWithID3Restricted(50, featureSize);
